...
void read_sensors_black(){
  ...
  // PID for 10 sensors
  line = (s1_c * 1) + (s2_c * 2) + (s3_c * 3) + (s4_c * 4) + (s5_c * 5) + (s6_c * 6) + (s7_c * 7) + (s8_c * 8) + (s9_c * 9) + (s10_c * 10) +(s11_c * 11) + (s12_c * 12);
  line = line * 10;
  line = line / (s1_c + s2_c + s3_c + s4_c + s5_c + s6_c + s7_c + s8_c + s9_c + s10_c + s11_c + s12_c);
  line = line - 10;
...
void follow(){
  ...
  { 
    ...
    if(power_difference > -6 && power_difference < 6) set_motors(150, 150);
    ...
    if (pos == 2)
      set_motors(turn_vel, -turn_vel + 50);
    else if (pos == 0) 
      set_motors(-turn_vel + 50, turn_vel);
    else if(pos == 1)
      set_motors(200, 200);
  }
}
